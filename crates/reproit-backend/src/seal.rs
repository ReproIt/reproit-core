...
use reproit_core::{
    ...
    model::{
        ...
        CaptureBatchManifest, ChunkKeyContext, ChunkKeyContextFormat, DiscoverySource,
        EncryptedChunk, EncryptedObject, FuzzContext, LogicalObject, LogicalObjectRole,
        ManifestUploadObject, ObjectKeyContext, ObjectKeyContextFormat, UploadEnvelope,
        UploadEnvelopeFormat, UploadObject, Validate, WrappedKey, validate_manifest_binding,
    },
    proof,
};
...
fn build_envelope(
    ...
    let mut envelope = UploadEnvelope {
        ...
        capture_id: request.metadata.capture_id,
        cipher_suite: "AES-256-GCM+HKDF-SHA-256".to_owned(),
        discovery_source: request.metadata.discovery_source,
